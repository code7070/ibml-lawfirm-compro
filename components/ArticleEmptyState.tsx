      ...
      <div className="relative py-28 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto flex flex-col items-center text-center">
          ...
          >
            <line
              className="orn-line"
              x1="0" y1="6" x2="256" y2="6"
              stroke="#D4C5A0"
              strokeWidth="0.75"
            />
            <line
              className="orn-line orn-line-delay"
              x1="0" y1="10" x2="256" y2="10"
              stroke="#D4C5A0"
              strokeWidth="0.35"
            />
            <circle cx="128" cy="6" r="4" fill="#D4C5A0" className="orn-scales" />
            <polygon
          ...
          <div className="orn-scales mb-8">
            ...
            >
              {/* Stand */}
              <line x1="40" y1="12" x2="40" y2="68" stroke="#D4C5A0" strokeWidth="1.5" />
              <line x1="28" y1="68" x2="52" y2="68" stroke="#D4C5A0" strokeWidth="1.5" />
              {/* Beam */}
              <line x1="14" y1="20" x2="66" y2="20" stroke="#D4C5A0" strokeWidth="1.5" />
              {/* Left chain */}
              <line x1="18" y1="20" x2="18" y2="38" stroke="#D4C5A0" strokeWidth="1" strokeDasharray="2 2" />
              {/* Right chain */}
              <line x1="62" y1="20" x2="62" y2="38" stroke="#D4C5A0" strokeWidth="1" strokeDasharray="2 2" />
              {/* Left pan */}
              <path d="M8 38 Q18 46 28 38" stroke="#D4C5A0" strokeWidth="1.5" fill="none" />
              {/* Right pan */}
              <path d="M52 38 Q62 46 72 38" stroke="#D4C5A0" strokeWidth="1.5" fill="none" />
              {/* Top ornament */}
              <circle cx="40" cy="12" r="2.5" stroke="#D4C5A0" strokeWidth="1.2" fill="none" />
              {/* Corner ornaments */}
              <line x1="10" y1="12" x2="14" y2="20" stroke="#D4C5A0" strokeWidth="0.75" strokeOpacity="0.4" />
              <line x1="70" y1="12" x2="66" y2="20" stroke="#D4C5A0" strokeWidth="0.75" strokeOpacity="0.4" />
            </svg>
          </div>

          {/* Roman numeral tag */}
          <span
            className="orn-text-1 text-[10px] font-bold tracking-[0.4em] uppercase text-[#D4C5A0] mb-4"
          >
          ...
          {/* Main headline */}
          <h3
            className="orn-text-2 text-3xl md:text-4xl font-serif font-light text-[#0B1B3B] mb-4 leading-tight"
          >
